...
<meta name="copyright" content="All Rights Reserved, Copyright (C) 2020, 张力, Ltd." />
<title></title>
...
<!-- 修改密码窗口 -->
<div id="edit-dialog" class="easyui-dialog" data-options="closed:false,iconCls:'icon-save',title:'修改密码',buttons:[{text:'确认修改',iconCls: 'icon-ok',handler:submitEdit}]" " style="width:450px; padding:10px;">
