...
<div id="select-authority-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:300px;height:450px; padding:10px;">
	<ul id="authority-tree" class="easyui-tree"
	url="get_all_menu"
	checkbox="true"></ul>
...
<script type="text/javascript">
	...
	*/
	...
	while(toDo.length){
		//把todo里的转移到node里，todo里删一个，node里加一个
